---
type: plan
source_file: Needs_Action/LINKEDIN_LEAD_Haiqa_Shahid_20260222_163702.md
source: linkedin
created: 2026-02-22T16:37:06.278843+00:00
status: planned
priority: high
risk: medium
...
# Objective
Process and respond to **linkedin** item from **Haiqa Shahid** regarding "Dm".

# Context
- **Origin:** linkedin
- **Sender / Name:** Haiqa Shahid
- **Subject / Topic:** Dm
- **Received:** 2026-02-22 16:37:02.430863+00:00
- **Priority:** HIGH
- **Risk:** MEDIUM

## Summary
**Profile:**  **Received:** 2026-02-22 16:37:02 UTC **Priority:** HIGH  ⚡ LEAD
DETECTED   Pricing quote test   - [ ] Review profile and message - [ ] Accept or
decline connection / reply to DM - [ ] Qualify as a lead and move to CRM - [ ]
Draft a personalised reply - [ ] Move this file to /Done when complete
...
`Pending_Approval/APPROVAL_SEND_LINKEDIN_DM_Haiqa_Shahid_LINKEDIN_LEAD_Ha_2026-02-22.md`
